...
# Install Python3 + chatbot dependencies
...
RUN python3 -c "\
import nltk; \
p='/usr/local/share/nltk_data'; \
nltk.download('punkt',                          download_dir=p, quiet=True); \
nltk.download('punkt_tab',                      download_dir=p, quiet=True); \
nltk.download('averaged_perceptron_tagger',     download_dir=p, quiet=True); \
nltk.download('averaged_perceptron_tagger_eng', download_dir=p, quiet=True); \
nltk.download('wordnet',                        download_dir=p, quiet=True)"
